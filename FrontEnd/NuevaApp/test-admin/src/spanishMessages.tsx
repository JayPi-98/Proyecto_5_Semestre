...
const spanishMessages: TranslationMessages = {
    ra: {
        ...
        message: {
            ...
            clear_array_input: '¿Estás seguro de que deseas borrar la lista completa?',
        ...
        configurable: {
            ...
            inspector: {
                title: 'Inspector',
                content: 'Pasa el ratón por encima de los elementos de la aplicación para configurarlos',
